...
class SpriteObject:
    def __init__(self, game, path='images/resources/sprites/staticSprites/candlebra.png',
                 pos=(4.5, 4.5), scale=0.8, shift=0.2):
        self.game = game
...
class AnimatedSprite(SpriteObject):
    def __init__(self, game, path='images/resources/sprites/animatedSprites/greenLight/0.png', 
                pos=(7.2, 5.75), scale=0.8, shift=0.15, animationTime=120):
